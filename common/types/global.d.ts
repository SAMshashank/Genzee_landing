...
export declare global {
  ...
  interface ServerToClientEvents {
    ...
    joined: (roomId: string, model:string,failed?: boolean) => void;
    ...
    showCameraPermisson: any;
    showZengFlowers: any;
    askCameraPermisson: any;
    setSoketModel:any;
    soketModelLeave: any;
  }
  ...
  interface ClientToServerEvents {
    ...
    join_room: (room: string, username: string,model:string) => void;
    joined_room: () => void;
    leave_room: () => void;
    send_msg: (msg: string) => void;
    modelData: any;
    joinRoom: (roomId: any, model: string) => void;
    leaveRoom: (roomId: any) => void;
    getCameraPermission: (roomId: any) => void;
    setCameraPermission: (roomId: any) => void;
    zengFlower: (roomId: any, emoji: any) => void;
  }
}
